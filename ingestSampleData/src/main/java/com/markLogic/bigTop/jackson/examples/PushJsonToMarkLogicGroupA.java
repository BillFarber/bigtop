...
public class PushJsonToMarkLogicGroupA {
    ...
    public static void main(String[] args) {
        PushJsonToMarkLogicGroupA obj = new PushJsonToMarkLogicGroupA();
        obj.run();
    }
    ...
    private static void writeJacksonDocument(Product product) {
        try {
            ...
            permissions.add("BigTopReaderARole", DocumentMetadataHandle.Capability.READ);
            ...
            textDocMgr.writeAs("/product/productA1a.json", metaHandle, productJson);
            ...
            jsonDocManager.writeAs("/product/productA1b.json", product);

            StringHandle productHandle = new StringHandle(productJson);
            jsonDocManager.write("/product/productA1c.json", metaHandle, productHandle);
        } catch (Throwable t) {
            t.printStackTrace();
        }
    }
